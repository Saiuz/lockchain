...
(function() {
  ...
  Contract.new = function() {
    if (this.currentProvider == null) {
      throw new Error("PolicyDecisionBase error: Please call setProvider() first before calling new().");
    }

    var args = Array.prototype.slice.call(arguments);

    if (!this.unlinked_binary) {
      throw new Error("PolicyDecisionBase error: contract binary not set. Can't deploy new instance.");
    }
    ...
    if (unlinked_libraries != null) {
      ...
      throw new Error("PolicyDecisionBase contains unresolved libraries. You must deploy and link the following libraries before you can deploy a new version of PolicyDecisionBase: " + unlinked_libraries);
    }
  ...
  Contract.at = function(address) {
    if (address == null || typeof address != "string" || address.length != 42) {
      throw new Error("Invalid address passed to PolicyDecisionBase.at(): " + address);
    }
  ...
  Contract.deployed = function() {
    if (!this.address) {
      throw new Error("Cannot find deployed address: PolicyDecisionBase not deployed or address not set.");
    }
  ...
  Contract.contract_name   = Contract.prototype.contract_name   = "PolicyDecisionBase";
  ...
  if (typeof module != "undefined" && typeof module.exports != "undefined") {
    ...
    // and we can use that.
    window.PolicyDecisionBase = Contract;
  }
})();
